...
export default function HeroBanner() {
  return (
    <section className="w-full max-w-screen-2xl mx-auto overflow-hidden text-white">
      <div className="flex flex-col sm:flex-row items-start px-4 sm:px-6 lg:px-8 py-6 sm:items-center gradient-color rounded-2xl justify-between gap-4">
        <div>
      ...
      <div className="mt-5 bg-white rounded-2xl text-gray-800 flex flex-col items-center shadow-sm justify-center py-10 border border-gray-300/50">
        ...
        <button className="primary-color flex items-center justify-between text-white font-medium px-7 py-3 rounded-md transition">
