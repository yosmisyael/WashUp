...
const TruckIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
  ...
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-1.5-1.5V10.5a1.5 1.5 0 011.5-1.5h6a1.5 1.5 0 011.5 1.5v7.5a1.5 1.5 0 01-1.5 1.5H8.25zm6-9a3 3 0 100-6 3 3 0 000 6z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 9H7.5M18.75 9a3 3 0 013 3v7.5a3 3 0 01-3 3H7.5M18.75 9a3 3 0 003-3v-1.5a3 3 0 00-3-3H7.5M18.75 9a3 3 0 003-3v-1.5a3 3 0 00-3-3H7.5" />
  </svg>
);

// SVG Icon untuk Cart (di Order Summary)
const CartIcon = ({ className = "w-12 h-12" }: { className?: string }) => (
  ...
  >
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h19.5M2.25 3v18M2.25 3h19.5v18M2.25 3h19.5v18H2.25V3z" />
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-start mb-6">
          ...
          {/* Progress Steps (Versi Gambar: 1 — 2 — 3) */}
                ...
                >
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex items-start">
                      ...
                      <div>
                        <label className="font-medium text-gray-900 block">Delivery Service</label>
...
<button
  onClick={() => window.location.href = '/customers/new-order/services'}
  className="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors font-medium text-sm"
>
